export default function Loading() {
  return (
    <div className="space-y-6 p-6">
      <div className="h-6 w-44 rounded-lg bg-yellow-100 animate-pulse" />
      <div className="rounded-2xl border border-yellow-100 bg-white p-4 shadow-sm">
        <div className="mb-3 flex items-center justify-between">
          ...
          <div className="h-9 w-28 rounded-lg bg-yellow-50 animate-pulse" />
        </div>
        <div className="overflow-hidden rounded-xl border border-yellow-100">
          <div className="grid grid-cols-5 border-b border-yellow-100 bg-yellow-50/60 p-3 text-xs">
